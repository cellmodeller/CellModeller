...
import sys
import pandas as pd
sys.path.append('../../script/diffusion rate')
...
param_config = '../../input/param_config_diffusion_rate.txt'
...
running_abc(exp_data, param_config, output_directory, number_of_particles, max_populations, epsilon)

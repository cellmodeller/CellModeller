...
def update(cells):
    for (id, cell) in cells.iteritems():
        ...
        strain = dl/cell.volume
        cell.color = [strain*10,0,0] #cell_colors[cell.cellType]
...
def divide(parent, d1, d2):
    ...
    d1.volume = parent.volume*0.5
    d2.volume = parent.volume*0.5
    d1.prevlen = parent.prevlen*0.5
    d2.prevlen = parent.prevlen*0.5
